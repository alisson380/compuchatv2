    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#4cb861" },
                textPrimary: mode === "light" ? "#4cb861" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#4cb861" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#4cb861" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #4cb861, #4cb861, #4cb861)" : "#666",
